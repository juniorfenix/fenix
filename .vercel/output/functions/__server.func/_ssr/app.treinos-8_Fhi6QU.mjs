...
import { u as useAuth, a as perfilQuery, n as planosTreinoAlunoQuery, p as profileQuery, t as treinosWeekQuery, D as Dialog, d as DialogContent, e as DialogHeader, f as DialogTitle, o as DialogDescription, q as planoExerciciosQuery, r as conclusoesTreinoQuery, s as supabase } from "./router-DSsXXfgN.mjs";
...
function PlanoTreinoView({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: !!selected, onOpenChange: (o) => !o && setSelected(null), children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogContent, { className: "max-w-md max-h-[90vh] overflow-y-auto", children: selected && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2", children: [
        selected.exercicio.grupo_muscular && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-flex items-center rounded-full border border-border/60 px-2.5 py-1 text-[11px] text-muted-foreground capitalize", children: selected.exercicio.grupo_muscular }),
        selected.exercicio.equipamento && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-flex items-center rounded-full border border-border/60 px-2.5 py-1 text-[11px] text-muted-foreground capitalize", children: selected.exercicio.equipamento }),
        selected.exercicio.nivel && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-flex items-center rounded-full border border-border/60 px-2.5 py-1 text-[11px] text-muted-foreground capitalize", children: selected.exercicio.nivel })
      ] }),
      selected.exercicio.descricao && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm leading-relaxed whitespace-pre-line", children: selected.exercicio.descricao })
      ] }),
