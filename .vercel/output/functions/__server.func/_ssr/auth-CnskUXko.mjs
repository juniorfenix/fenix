...
function AuthPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex h-dvh items-center justify-center px-6 py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-md", children: [
