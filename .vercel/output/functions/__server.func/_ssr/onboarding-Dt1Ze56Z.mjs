...
import { u as useAuth, s as supabase } from "./router-CcOOaUOf.mjs";
...
import { U as Users, F as Flame, S as Sparkles, A as ArrowLeft, a as ArrowRight, C as Check, b as Apple, D as Drumstick, W as Wheat, M as Milk, c as Salad, d as Soup, Z as Zap, e as ChefHat, L as Leaf, f as Search, X, B as Ban } from "../_libs/lucide-react.mjs";
...
const STEPS_ALUNO = ["tipo_conta", "dados", "objetivo_peso", "atividade", "objetivo_fenix", "favorito", "evitar", "restricao", "essenciais", "detestados", "estilo", "restricoes_alim", "pronto"];
const STEPS_PROF = ["tipo_conta", "especialidade", "pronto"];
const ESSENCIAIS = [{
  key: "Frutas",
  label: "Frutas",
  Icon: Apple
...
function Onboarding() {
  ...
  const steps = reactExports.useMemo(() => form.tipo_conta === "profissional" ? STEPS_PROF : STEPS_ALUNO, [form.tipo_conta]);
  ...
  const finishProfissional = async () => {
    ...
    try {
      ...
      clearInterval(tick);
      if (!mountedRef.current) return;
      queryClient.setQueryData(["perfil", user.id], (old) => ({
        ...old ?? {},
        papel: form.especialidade
      }));
  ...
  if (preparing) {
    ...
    const stages = isProfissionalPrep ? ["Ativando seu perfil profissional…", "Configurando seu painel…", "Tudo pronto. Bem-vindo!"] : ["Analisando seu perfil metabólico…", "Calculando sua meta calórica…", "Montando seu plano Fênix…", "Tudo pronto. Renascendo."];
    return /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "min-h-screen bg-background px-6 py-10 grid place-items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-md w-full text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto h-20 w-20 rounded-full bg-gradient-ember grid place-items-center shadow-ember animate-pop", children: isProfissionalPrep ? /* @__PURE__ */ jsxRuntimeExports.jsx(Users, { className: "h-9 w-9 text-primary-foreground", strokeWidth: 2 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Flame, { className: "h-9 w-9 text-primary-foreground", strokeWidth: 2 }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mt-8 text-3xl", children: isProfissionalPrep ? "Ativando seu perfil" : "Preparando seu plano" }),
  ...
  const finalLabel = form.tipo_conta === "profissional" ? busy ? "Ativando…" : "Ativar perfil profissional" : busy ? "Salvando…" : "Renascer agora";
  return /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "min-h-screen bg-[radial-gradient(ellipse_at_top,rgba(255,90,30,0.12),transparent_60%)] bg-background text-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex min-h-screen max-w-xl flex-col px-6 py-6", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 pb-2", children: [
      ...
      !showEncourage && (!isLastStep ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { onClick: goNext, disabled: !canNext, className: "h-14 flex-[2] text-base bg-gradient-ember text-primary-foreground shadow-ember", children: [
        "Continuar ",
        /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "h-4 w-4 ml-1" })
      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: finish, disabled: busy, className: "h-14 flex-[2] text-base bg-gradient-ember text-primary-foreground shadow-ember", children: finalLabel }))
    ] })
  ] }) });
}
function StepScreen({
  ...
  if (step === "tipo_conta") {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-3xl leading-tight sm:text-4xl", children: "Como você vai usar o Fênix?" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-base text-muted-foreground", children: "Escolha seu perfil para personalizarmos sua experiência." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 space-y-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(BigChoice, { selected: form.tipo_conta === "aluno", onClick: () => set("tipo_conta", "aluno"), title: "Sou aluno", subtitle: "Quero emagrecer, ganhar músculo ou melhorar minha saúde" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(BigChoice, { selected: form.tipo_conta === "profissional", onClick: () => set("tipo_conta", "profissional"), title: "Sou profissional", subtitle: "Sou instrutor, nutricionista ou profissional da saúde" })
      ] })
    ] });
  }
  if (step === "especialidade") {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-3xl leading-tight sm:text-4xl", children: "Qual é a sua especialidade?" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-base text-muted-foreground", children: "Isso define as ferramentas que você terá acesso no painel." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 space-y-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(BigChoice, { selected: form.especialidade === "instrutor", onClick: () => set("especialidade", "instrutor"), title: "Instrutor de treino", subtitle: "Crio planos de treino e acompanho alunos no exercício" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(BigChoice, { selected: form.especialidade === "nutricionista", onClick: () => set("especialidade", "nutricionista"), title: "Nutricionista", subtitle: "Crio planos alimentares e acompanho a dieta dos pacientes" })
      ] })
    ] });
  }
  if (step === "dados") {
  ...
  if (form.tipo_conta === "profissional") {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto h-16 w-16 rounded-full bg-gradient-ember grid place-items-center shadow-ember", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Users, { className: "h-8 w-8 text-primary-foreground" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "mt-6 font-display text-3xl leading-tight sm:text-4xl", children: "Seu perfil profissional está pronto." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-base text-muted-foreground", children: "Você terá acesso ao painel de alunos, planos de treino e acompanhamento personalizado." })
    ] });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
