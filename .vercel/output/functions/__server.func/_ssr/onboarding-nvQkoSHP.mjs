...
function Onboarding() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "min-h-screen bg-[radial-gradient(ellipse_at_top,rgba(255,90,30,0.12),transparent_60%)] bg-background text-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex min-h-screen max-w-xl flex-col px-6 py-6", children: [
    ...
    ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx(StepScreen, { step: current, form, set, onEnter: canNext ? goNext : void 0 }) }),
...
function StepScreen({
  ...
  if (step === "dados") {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 grid grid-cols-2 gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(BigField, { label: "Peso (kg)", value: form.current_weight, onChange: (v) => set("current_weight", v), type: "number" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(BigField, { label: "Altura (cm)", value: form.height, onChange: (v) => set("height", v), type: "number" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(BigField, { label: "Idade", value: form.age, onChange: (v) => set("age", v), type: "number" }),
  ...
  if (step === "objetivo_peso") {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BigField, { label: "Peso desejado (kg)", value: form.goal_weight, onChange: (v) => set("goal_weight", v), type: "number", onEnter }) })
    ] });
  }
  if (step === "atividade") {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
...
function BigField({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type, inputMode: type === "number" ? "decimal" : void 0, value, onChange: (e) => onChange(e.target.value), onKeyDown: (e) => {
