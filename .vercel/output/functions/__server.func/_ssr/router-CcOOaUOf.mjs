...
const appCss = "/assets/styles-CE8LCbNy.css";
...
const $$splitComponentImporter$f = () => import("./onboarding-Dt1Ze56Z.mjs");
...
const $$splitComponentImporter$e = () => import("./auth-D4iE19UF.mjs");
const Route$e = createFileRoute("/auth")({
  component: lazyRouteComponent($$splitComponentImporter$e, "component")
});
const $$splitComponentImporter$d = () => import("./app-22l4eP8_.mjs");
const Route$d = createFileRoute("/app")({
  component: lazyRouteComponent($$splitComponentImporter$d, "component")
});
const $$splitComponentImporter$c = () => import("./index-Cq2DFo4g.mjs");
const Route$c = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter$c, "component")
});
const $$splitComponentImporter$b = () => import("./app.index-C41SLq80.mjs");
const Route$b = createFileRoute("/app/")({
  component: lazyRouteComponent($$splitComponentImporter$b, "component")
});
const $$splitComponentImporter$a = () => import("./app.treinos-CL2JQB8h.mjs");
const Route$a = createFileRoute("/app/treinos")({
  component: lazyRouteComponent($$splitComponentImporter$a, "component")
});
const $$splitComponentImporter$9 = () => import("./app.profile-CD7WuOXW.mjs");
...
const $$splitComponentImporter$8 = () => import("./app.meu-plano-A1G7auMs.mjs");
const Route$8 = createFileRoute("/app/meu-plano")({
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./app.method-BSTg6btW.mjs");
const Route$7 = createFileRoute("/app/method")({
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./app.instrutor-3xZmCqqd.mjs");
const Route$6 = createFileRoute("/app/instrutor")({
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./app.alimentacao-BP9aUAP2.mjs");
...
const $$splitComponentImporter$4 = () => import("./app.admin-BrqzuIBR.mjs");
const Route$4 = createFileRoute("/app/admin")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./app.instrutor.exercicios-BVphHbrg.mjs");
const Route$3 = createFileRoute("/app/instrutor/exercicios")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./app.instrutor._alunoId-DcpCyb-F.mjs");
const Route$2 = createFileRoute("/app/instrutor/$alunoId")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./app.guias._chave-HFq1I84n.mjs");
const Route$1 = createFileRoute("/app/guias/$chave")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./app.admin._userId-BrR4s0EK.mjs");
...
export {
  ...
  planosTreinoInstrutorQuery as C,
  Dialog as D,
  planosAlimentaresInstrutorQuery as E,
  Route$1 as F,
  Route as G,
  router as H,
  Route$2 as R,
