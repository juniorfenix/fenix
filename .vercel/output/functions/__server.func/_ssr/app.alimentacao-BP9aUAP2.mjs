...
import { u as useAuth, a as perfilQuery, p as profileQuery, y as planosAlimentaresAlunoQuery, s as supabase, z as adesaoAlimentarQuery, A as planoRefeicoesQuery, D as Dialog, d as DialogContent, e as DialogHeader, f as DialogTitle, x as DialogFooter } from "./router-CcOOaUOf.mjs";
import { t as todayISO } from "./calories-D7mpMhLM.mjs";
import { S as Skeleton } from "./skeleton-DHtiC9Nz.mjs";
import { B as Button, I as Input } from "./input-DdPWwA8I.mjs";
import { L as Label } from "./label-yzMr112s.mjs";
import { T as Textarea } from "./textarea-CUIevnmE.mjs";
import { t as toast } from "../_libs/sonner.mjs";
import { C as Card, a as CardContent, b as CardHeader, c as CardTitle } from "./card-BS7Rdi4u.mjs";
...
import { k as Utensils, y as Droplet, T as TrendingDown, L as Leaf, ad as TrendingUp, p as Target, x as Beef, W as Wheat, c as Salad, a8 as Clock, N as CircleCheck, O as Circle, ae as ClipboardList, a1 as ArrowRightLeft, af as Camera, ag as Image, ah as Coffee, b as Apple, j as Dumbbell, q as UtensilsCrossed, a4 as Moon, P as Plus, F as Flame, R as Pencil, ai as Trash2, f as Search, S as Sparkles, t as LoaderCircle, C as Check, Z as Zap, l as BookOpen, B as Ban, z as TriangleAlert, aj as CircleAlert } from "../_libs/lucide-react.mjs";
...
function PlanoAlimentarCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass rounded-2xl p-5 space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-3", children: [
      ...
      adesoes.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[11px] text-muted-foreground shrink-0", children: [
        adesoes.length,
        " dias (30d)"
      ] })
    ] }),
    ...
    (plano.meta_kcal || plano.meta_proteinas_g) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-4 gap-2", children: [
      plano.meta_kcal && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl bg-primary/5 border border-primary/20 p-2.5 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] uppercase tracking-wider text-muted-foreground", children: "kcal" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-bold text-primary", children: plano.meta_kcal })
      ] }),
      plano.meta_proteinas_g && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl bg-primary/5 border border-primary/20 p-2.5 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] uppercase tracking-wider text-muted-foreground", children: "prot" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-sm font-bold text-primary", children: [
          plano.meta_proteinas_g,
          "g"
        ] })
      ] }),
      plano.meta_carboidratos_g && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl bg-primary/5 border border-primary/20 p-2.5 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] uppercase tracking-wider text-muted-foreground", children: "carb" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-sm font-bold text-primary", children: [
          plano.meta_carboidratos_g,
          "g"
        ] })
      ] }),
      plano.meta_gorduras_g && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl bg-primary/5 border border-primary/20 p-2.5 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] uppercase tracking-wider text-muted-foreground", children: "gord" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-sm font-bold text-primary", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-border/30 pt-4", children: [
      ...
      loadingRef ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-12 rounded-xl bg-muted/30 animate-pulse" }) : refeicoes.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-xl border border-dashed border-border/60 p-4 text-center text-xs text-muted-foreground", children: "Seu profissional ainda não detalhou as refeições deste plano." }) : /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2", children: refeicoes.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "rounded-xl border border-border bg-card/50 p-3", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => jaSeguiu ? desmarcar.mutate() : marcar.mutate(), disabled: marcar.isPending || desmarcar.isPending, className: `w-full flex items-center justify-center gap-2 rounded-xl py-2.5 text-sm font-medium transition border ${jaSeguiu ? "bg-primary/10 border-primary/40 text-primary" : "border-border bg-card/40 text-muted-foreground hover:border-primary/40 hover:text-primary"}`, children: [
...
function AlimentacaoPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AlimentacaoAluno, {});
}
function AlimentacaoAluno() {
  ...
  const {
    ...
    isLoading: loadingPlanosAlimentares
  } = useQuery({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "mx-auto max-w-md px-5 pt-8 pb-8 space-y-5", children: [
    ...
    !loadingPlanosAlimentares && planosAlimentares.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] uppercase tracking-widest text-muted-foreground px-1", children: "Plano prescrito pelo profissional" }),
      planosAlimentares.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsx(PlanoAlimentarCard, { plano: p, alunoId: user.id }, p.id))
    ] }) : !loadingPlanosAlimentares ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass rounded-2xl p-6 text-center space-y-2 border border-dashed border-border/60", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-3xl", children: "🥗" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-medium", children: "Nenhum plano alimentar prescrito ainda" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground", children: "Assim que seu profissional montar sua dieta, ela aparecerá aqui." })
    ] }) : null,
