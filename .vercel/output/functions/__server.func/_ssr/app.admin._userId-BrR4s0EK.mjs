...
import { G as Route, u as useAuth, a as perfilQuery, s as supabase } from "./router-CcOOaUOf.mjs";
import { C as Card, b as CardHeader, c as CardTitle, a as CardContent } from "./card-BS7Rdi4u.mjs";
...
import { A as AlertasTrocas } from "./alertas-trocas-jLqo_XxN.mjs";
import { A as ArrowLeft, ak as Download, ae as ClipboardList, I as Save, P as Plus, ai as Trash2, f as Search } from "../_libs/lucide-react.mjs";
...
function AdminAlunoDetalhe() {
  ...
  const {
    ...
    ...perfilQuery(user?.id ?? ""),
    enabled: !!user?.id,
    select: (data2) => data2?.papel === "admin"
  });
  reactExports.useEffect(() => {
